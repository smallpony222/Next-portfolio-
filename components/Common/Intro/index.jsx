...
const Intro = () => {
  return (
    <>
      {/* fixed at top */}
      <div className='my-photo headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        {/* <Image className='w-25 h-25 rounded-full' src={me} alt='profile picture' /> */}
      </div>
      ...
      <div className='beech z-20 flex flex-col overflow-y-scroll pt-48 top-48 space-y-6 divide-y divide-white overflow-x-hidden no-scrollbar px-4'>
        <div className='flex flex-col items-center justify-center'>
          ...
          <span className='text-sm text-LightGray text-center mt-2' style={{ whiteSpace: 'pre-wrap' }} >{DESIGNATION}</span>
        </div>
        <Location />
        {/* <Languages /> */}
        <Skills />
